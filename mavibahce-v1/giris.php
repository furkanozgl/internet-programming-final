...
<body>
    <nav>
        <ul>
            ...
            <li><a href="#"><i class="fa fa-book"></i>&nbsp;  Giriş Yap</a></li>
    ...
    <div id="form1" class="row kpx_row-sm-offset-3">
			<div class="col-xs-12 col-sm-6">	
			    <form class="kpx_loginForm" action="" autocomplete="off" method="POST">
                    ...
                    <hr />
					<button class="btn btn-lg btn-outline-primary btn-block" type="submit"><i class="fa fa-sign-in"></i> Giriş Yap</button>
				</form>
			</div>
    	</div>
